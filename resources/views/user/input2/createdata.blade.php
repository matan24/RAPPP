...
@section('title', 'Input Data Pribadi | April Group')
       ...
       <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-4">
                <a href="{{ route('user.input2.detaildata') }}" class="btn btn-info">Lihat data pribadi</a>
                <br>
                <form action="{{ route('user.input2.createdata.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <br>
                    @if (session('status'))
