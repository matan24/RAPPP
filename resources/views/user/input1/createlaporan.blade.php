       ...
       <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-4">
                ...
                <br>
                <a href="{{ route('user.input1.detaillaporan') }}" class="btn btn-info">Lihat Laporan</a>
                <br>
                <form action="{{ route('user.input1.createlaporan.store') }}" method="post">
                    @csrf
                    <br>
                    @if (session('status'))
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-8">
                        <textarea name="laporan" id="editor" cols="30" rows="10"></textarea>
                      </div>
                    </div>
