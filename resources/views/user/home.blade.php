    ...
    <div class="card shadow mb-4">
        <div class="card-header py-4">
            <p class="alert alert-primary" style="width: 36rem;">
                <b>Kepada seluruh karyawan, wajib melengkapi data pribadi </b>
            </p>
            <p class="alert alert-primary" style="width: 36rem;" >
            ...
            <div class="jumbotron jumbotron-fluid alert alert-primary">
                <div class="">
                    <p class="text-muted">
                        <b>- Lihat informasi terbaru</b> <a href="{{ route('user.input1.informasi') }}" class="btn btn-primary btn-lg"><i class="bi bi-eye-fill"></i></a>
                    </p>
                    <p class="text-muted">
